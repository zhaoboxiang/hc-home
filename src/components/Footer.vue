    ...
    <div class="content hc-footer">
      <div class="hc-footer-content">
        ...
        <div class="hc-info-content">
          ...
          <div class="addr">
            商务合作：business@hcttop.com
            <br />公司地址：深圳市南山区科技园中区国人通信大厦A座13层
          </div>
      ...
      <footer>
        ...
        <a href="http://www.beian.miit.gov.cn" target="_blank"><i></i>粤ICP备19122684号-2</a>
      </footer>
    </div>
  </div>
</template>
    ...
    .hc-footer-content {
      ...
      .hc-info-content {
        ...
        .footer-logo {
          width: 200px;
          height: 80px;
          background: url("../assets/images/img_footer_logo.png") center
            no-repeat;
          background-size: 100% 100%;
          margin-top: 32px;
        }
