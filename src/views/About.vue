    ...
    <div class="introduction-box">
      <div class="content introduction-content">
        ...
        <div class="intro-info">
          <div class="info">
            <p>虹川科技成立于2015年，总部位于中国深圳，是中国领先的绿色智慧城市解决方案服务商。</p>
            <p>公司主营业务为智慧环保（环境与安全监测管理、综合和专项环境治理）、智慧水利水务和智慧园区等，致力于物联网、大数据、人工智能和5G通信等技术在上述行业的综合应用和产业落地，向客户提供以环境质量改善为目标的先进技术服务和整体解决方案。<br /></p>
            <p>公司核心团队均来自华为、中兴、阿里、平安等知名企业，成功实施过深圳、上海、济南等多个智慧城市的标杆项目。虹川科技高度重视人才和团队建设，全面设立和实施“优秀合伙人”和“优秀人才”计划，以价值创造为根本，成就共同理想为目标，欢迎各类优秀贤士加入。<br /></p>
            <p>公司始终坚持以“科技赋能、产业报国”为使命，注重科技和产业的并重发展，寻求和加强与自身产业具有高度匹配性的各级政府开展合作，努力创建具有高度竞争力和良好美誉度的行业品牌。<br /></p>
            <p>“适者生存，迎势而为”，虹川科技将矢志不渝的坚持“品质、责任，创新、协作”的发展理念，坚定向着成为大型百亿智慧产业集团的目标奋进。</p>
          </div>
          <div class="img"></div>
        </div>
...
.about-banner-box {
  ...
  .banner-content {
    height: 100%;
    background: url("../assets/images/img_about_banner_1_bg.png") right bottom
      no-repeat;
    overflow: auto;
    display: flex;
    align-items: center;
  ...
  .introduction-content {
    ...
    .intro-advantage {
      ...
      .adv-item {
        ...
        .icon-one {
          background: url("../assets/images/icon_about_youshi_1.png") center
            no-repeat;
        }
        .icon-two {
          background: url("../assets/images/icon_about_youshi_2.png") center
            no-repeat;
        }
        .icon-three {
          background: url("../assets/images/icon_about_youshi_3.png") center
            no-repeat;
        }
        .icon-four {
          background: url("../assets/images/icon_about_youshi_4.png") center
            no-repeat;
        }
        .adv-tips {
          text-align: center;
