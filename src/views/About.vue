<template>
  <div class="about">
      ...
      <div class="content introduction-content">
        ...
        <div class="intro-advantage">
          <div class="adv-item">
            ...
            <div class="adv-p">规模的学习型技术团队，技术研发实力雄厚，保证了技术应用的可持续反正和行业领先，为客户提供高品质的整体解决方案。</div>
          </div>
          <div class="adv-item">
    ...
    <!--服务案例-->
    <div class="server-cases-box">
      <div class="content">
        <h3 class="section-h3">服务案例</h3>
        <h6 class="section-h6">SERVICE CASES</h6>
        <div class="cases">
          <p>
            公司通过物联、数联和智联以及大数据领域的技术积累通，
            与人工智能技术的深度融合创新性的推出业界领先的智慧环保环保生态大数据平台、
            水务监管平台和园区监管运营平台等多套成熟平台产品。 <br/>
            平台在山东省生态环境厅、北京市公安局和深圳广州等多地产业园区实现落地应用。获得客户一致好评。
          </p>
        </div>
      </div>
    </div>
...
@import "../assets/css/global";
  ...
  .about-banner-box{
    height: 240px;
    width: 100%;
    background:linear-gradient(135deg,rgba(226,242,249,1) 0%,rgba(224,235,249,1) 49%,rgba(237,234,249,1) 100%);
    color: @font-color-active;
    .banner-content{
      height: 100%;
      background: url("../assets/images/img_about_banner_1_bg.png") right bottom no-repeat;
      overflow: auto;
      display: flex;
      align-items: center;
      .caption-cn{
    ...
    .introduction-content{
      .intro-info{
        ...
        .img{
          width: 420px;
          height: 280px;
          background: url("../assets/images/img_about_company_photo.png") center no-repeat;
        }
      }
      .intro-advantage{
        margin-top: 160px;
        ...
        .adv-item{
          ...
          &:after{
            ...
            right: 0;
            top: 0;
            background:linear-gradient(rgba(149,171,216,0) 0%,rgba(149,171,216,1) 50%,rgba(149,171,216,0) 100%);
          }
          &:first-child{
            padding-left: 0;
          }
          ...
          .icon-one{
            background: url("../assets/images/icon_about_youshi_1.png") center no-repeat;
          }
          .icon-two{
            background: url("../assets/images/icon_about_youshi_2.png") center no-repeat;
          }
          .icon-three{
            background: url("../assets/images/icon_about_youshi_3.png") center no-repeat;
          }
          .icon-four{
            background: url("../assets/images/icon_about_youshi_4.png") center no-repeat;
          }
          .adv-tips{
            text-align: center;
            padding: 20px 0 30px;
  ...
  .culture-box{
    ...
    .cul-content{
      ...
      &>.cul-box{
        ...
        .line{
          width:218px;
          height: 4px;
          background: url("../assets/images/img_about_culture_line.png") center repeat-x;
          position: relative;
          &:before,&:after{
            content: '';
            display: block;
        ...
        .cul-right{
          width: 800px;
          height: 400px;
          background: url("../assets/images/img_about_qyzz.png") center no-repeat;
        }
      }
    ...
    .cul-split{
      width: 100%;
      height: 250px;
      background: url("../assets/images/img_about_qywh_bg.png") center no-repeat;
      margin-bottom: 20px;
    }
  }
