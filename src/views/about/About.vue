      ...
      <div class="introduction-box">
        <div class="content introduction-content">
          ...
          <div class="intro-info">
            <div class="info">
              <p>
                虹川科技成立于2015年，总部位于中国深圳，是中国领先的绿色智慧城市综合解决方案服务商。主营业务为智慧环保、智慧水务和智慧园区等，致力于物联网、大数据、人工智能和5G通信等技术在业务领域的综合应用和产业落地，向客户提供以改善环境质量为目标的先进技术服务和整体解决方案。
              </p>

              <p>
                公司具有较强的科研实力，与国内众多科研机构保持着技术交流与合作。在智慧环保领域拥有国内最全面的整体解决方案，尤其在空气算法模型，污染源溯源分析、空气质量预报预警、企业电量监控等领域均处于业界领先水平。
              </p>
              <p>
                公司核心团队均来自华为、中兴、阿里、平安等企业，成功实施过深圳、上海、济南、济宁等多个标杆项目。
              </p>
              <p>
                公司始终坚持以“科技赋能、产业报国”为使命，注重科技和产业的并重发展，寻求和加强与自身产业具有高度匹配性的各级政府开展合作，努力创建具有高度竞争力和良好美誉度的行业品牌。
              </p>
              <p>
                虹川科技将矢志不渝的坚持“品质、责任，创新、协作”的发展理念，坚定向着成为大型百亿智慧产业集团的目标迈进。
              </p>
            </div>
            <div class="img"></div>
          </div>
...
export default {
  name: "about",
  components: { CompanyCulture, Header, Footer }
};
</script>
...
.about-banner-box {
  ...
  .banner-content {
    height: 100%;
    background: url("../../assets/images/img_about_banner_1_bg.png") right
      bottom no-repeat;
    overflow: auto;
    display: flex;
    align-items: center;
  ...
  .introduction-content {
    .intro-info {
      ...
      .img {
        width: 420px;
        height: 280px;
        background: url("../../assets/images/img_about_company_photo.png")
          center no-repeat;
      }
    }
    .intro-advantage {
...
.culture-box {
  ...
  .cul-content {
    ...
    & > .cul-box {
      ...
      .cul-right {
        width: 800px;
        height: 400px;
        background: url("../../assets/images/img_about_qyzz.png") center
          no-repeat;
      }
    }
  }
  .cul-split {
    width: 100%;
    height: 250px;
    background: url("../../assets/images/img_about_qywh_bg.png") center
      no-repeat;
    margin-bottom: 20px;
  }
}
...
.server-cases-box {
  ...
  .cases {
    ...
    .case-bg {
      ...
      width: 100%;
      height: 100%;
      background: url("../../assets/images/img_about_anli_bg.png") center
        no-repeat;
      top: 0;
      left: 0;
      z-index: -10;
