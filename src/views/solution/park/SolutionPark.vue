    ...
    <div class="solution">
      ...
      <div class="solution-banner-box">
        <div class="content banner-content">
          ...
          <div class="ban-right">
            <img
              src="../../../assets/images/solution/img_jjfa_zhyq_topimg.png"
            />
          </div>
        </div>
      </div>
        ...
        <div class="content section-content">
          ...
          <div class="section-flex">
            <div class="flex-item item-1">
              <div class="item-p">
                园区企业聚集式发展<br />园区经济向生态型转变
              </div>
            </div>
            <div class="flex-item item-2">
              <div class="item-p">
                园区产业链日趋完善<br />园区企业向高新型转变
              </div>
            </div>
        ...
        <div class="content section-content">
          ...
          <div class="section-flex">
            <div class="flex-item">
              ...
              <div class="item-p">
                依托GIS地图，以二/三维方式呈现，园区、设备、设施、人员、事件一图全方位展示。
              </div>
            </div>
            <div class="flex-item">
            ...
            <div class="flex-item">
              ...
              <div class="item-p">
                从园区管理者、入住企业到员工居民，从基础设施、物联感知到园区物业管理、服务管理、运营管理，平台覆盖园区各类业务与场景。
              </div>
            </div>
          </div>
        </div>
